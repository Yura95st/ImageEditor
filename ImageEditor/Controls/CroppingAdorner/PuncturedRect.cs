    ...
    public class PuncturedRect : Shape
    {
        ...
        protected override Geometry DefiningGeometry
        {
            get
            {
                ...
                pthfExt.StartPoint = this.RectExterior.TopLeft;
                pthfExt.Segments.Add(new LineSegment(this.RectExterior.TopRight, false));
                pthfExt.Segments.Add(new LineSegment(this.RectExterior.BottomRight, false));
                pthfExt.Segments.Add(new LineSegment(this.RectExterior.BottomLeft, false));
                pthfExt.Segments.Add(new LineSegment(this.RectExterior.TopLeft, false));
                pthgExt.Figures.Add(pthfExt);

                Rect rectIntSect = Rect.Intersect(this.RectExterior, this.RectInterior);
        ...
        public static readonly DependencyProperty RectInteriorProperty = DependencyProperty.Register("RectInterior",
            typeof(Rect), typeof(FrameworkElement),
            new FrameworkPropertyMetadata(new Rect(0, 0, 0, 0), FrameworkPropertyMetadataOptions.AffectsRender, null,
                PuncturedRect.CoerceRectInterior, false), null);
        ...
        public Rect RectInterior
        {
            get
            {
                return (Rect)this.GetValue(PuncturedRect.RectInteriorProperty);
            }
            set
            {
                this.SetValue(PuncturedRect.RectInteriorProperty, value);
            }
        }

        public static readonly DependencyProperty RectExteriorProperty = DependencyProperty.Register("RectExterior",
            typeof(Rect), typeof(FrameworkElement),
            new FrameworkPropertyMetadata(new Rect(0, 0, double.MaxValue, double.MaxValue),
                FrameworkPropertyMetadataOptions.AffectsMeasure | FrameworkPropertyMetadataOptions.AffectsArrange
                    | FrameworkPropertyMetadataOptions.AffectsParentMeasure
                    | FrameworkPropertyMetadataOptions.AffectsParentArrange | FrameworkPropertyMetadataOptions.AffectsRender,
        ...
        public Rect RectExterior
        {
            get
            {
                return (Rect)this.GetValue(PuncturedRect.RectExteriorProperty);
            }
            set
            {
                this.SetValue(PuncturedRect.RectExteriorProperty, value);
            }
        }
